(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("HideEmail", [], factory);
	else if(typeof exports === 'object')
		exports["HideEmail"] = factory();
	else
		root["HideEmail"] = factory();
})(this, function() {
...
module.exports = function () {
    ...
    function HideEmails() {
        var emailEles = document.querySelectorAll('.h-email');
        if (emailEles.length) {
            emailEles.forEach(function (ele) {
                return renderCanvas(ele);
            });
        }
    }
    ...
    function renderCanvas(ele) {
        ...
        var fontSizeInt = fontSize.match(/([0-9]+)/g).length ? parseInt(fontSize.match(/([0-9]+)/g)[0]) : 12;
        var canvas = document.createElement('canvas');
        var ctx = canvas.getContext('2d');
        var text = atob(ele.dataset.hea);
